export default function Hero() {
  return (
    <section className="flex flex-col justify-center items-center gap-4 sm:gap-8">
      <div className="rounded-2xl min-h-screen w-full sm:w-1/2 py-8 px-4 flex flex-col justify-center items-center bg-[url('/scribble-mask-bg.jpg')] bg-cover bg-center bg-fixed mask-radial mask-radial-from-10% mask-radial-to-100% overflow-hidden">
